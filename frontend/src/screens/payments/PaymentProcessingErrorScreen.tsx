...
export default function PaymentProcessingErrorScreen({ route }: any) {
  ...
  return (
    <SafeAreaView style={styles.container}>
      ...
      <Text style={styles.message}>{error?.userMessage || "We encountered an error processing your payment."}</Text>
