export const TestIDs = {
  ...
  PRODUCT_LIST: {
    ...
    PRODUCT_CARD: (id: string) => `productListScreen.productCard.${id}`,
    PRODUCT_CARD_IMAGE: (id: string) => `productListScreen.productCard.${id}.image`,
  ...
  PRODUCT_DETAIL: {
    ...
    SIZE_OPTION: (size: string) => `productDetailScreen.sizeOption.${size}`
  },
  CART: {
    SCREEN: "cartScreen",
    ITEM: (id: string) => `cartScreen.item.${id}`,
...
export type TestIDValue = string | ((...args: any[]) => string);
