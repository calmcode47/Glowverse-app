...
Follow these steps in order for maximum effectiveness. Each step builds on the previous one to create a protective barrier and healthy glow.`,
            ...
            tags: ['skincare', 'morning', 'routine', 'glowing-skin', 'beginner-friendly'],
            difficulty: 'BEGINNER',
            readTime: 8,
            duration: 10,
                ...
                create: [
                    {
                        ...
                        tips: ["Use lukewarm water, not hot", "Don't scrub too hard", "Choose a cleanser for your skin type"]
                    },
                    {
                        order: 2,
                        title: "Tone",
...
During sleep, skin cell regeneration increases and the skin is more receptive to active ingredients. Maximize this natural repair process with the right products.`,
            category: 'SKINCARE_ROUTINE',
            tags: ['skincare', 'evening', 'routine', 'anti-aging', 'repair'],
            difficulty: 'BEGINNER',
            readTime: 10,
            duration: 15,
                ...
                create: [
                    {
                        ...
                        tips: ["Don't tug on skin", "Pay attention to eye area", "Oil cleansers work for all skin types"]
                    },
                    {
                        order: 2,
                        title: "Double Cleanse",
                        content: "Follow up with a water-based cleanser to remove any remaining residue. This ensures completely clean skin.",
                        tips: ["Essential after wearing makeup/sunscreen", "Use gentle circular motions", "Rinse thoroughly"]
                    },
                    {
                        order: 3,
                        ...
                        tips: ["Don't over-exfoliate", "Start 1x per week", "Avoid mixing with retinol on same night"]
                    },
                    {
                        order: 4,
                        title: "Toner",
                        content: "Apply hydrating toner to replenish moisture and prep skin for treatment products.",
                        tips: ["Can use multiple layers (7 skin method)", "Pat in gently", "Choose calming ingredients for nighttime"]
                    },
                    {
                        order: 5,
                        ...
                        tips: ["Introduce retinol slowly", "Use pea-sized amount", "Always start with lower concentrations"]
                    },
                    {
                        order: 6,
                        ...
                        tips: ["Night creams can be richer than day creams", "Tap eye cream gently", "Consider sleeping masks for extra hydration"]
                    }
                ]
            }
        },
...
Different hair types need different care. Learn what works for your unique hair texture and needs.`,
            category: 'HAIRCARE',
            tags: ['haircare', 'tips', 'healthy-hair', 'shine'],
            difficulty: 'BEGINNER',
            readTime: 6,
...
Retinol is a vitamin A derivative that speeds up cell turnover, boosts collagen production, and helps treat acne and signs of aging.`,
            ...
            tags: ['retinol', 'anti-aging', 'skincare', 'advanced'],
...
Your skin is your body's largest organ and reflects your overall health. What you eat, drink, and how you live directly impacts your skin's appearance.`,
            category: 'WELLNESS',
            tags: ['wellness', 'lifestyle', 'holistic', 'healthy-habits'],
            difficulty: 'BEGINNER',
            readTime: 7,
...
Certain foods are packed with vitamins, minerals, and antioxidants that support skin and hair health.`,
            category: 'NUTRITION',
            tags: ['nutrition', 'diet', 'healthy-skin', 'healthy-hair', 'vitamins'],
            difficulty: 'BEGINNER',
            readTime: 10,
...
Korean skincare emphasizes prevention, hydration, and gentle care. It's about maintaining healthy skin,not just treating problems.`,
            category: 'SKINCARE_ROUTINE',
            tags: ['korean-beauty', 'skincare', 'advanced', 'k-beauty'],
            difficulty: 'ADVANCED',
            readTime: 18,
...
Men's skin is about 25% thicker than women's and produces more oil. It requires specific care approaches.`,
            ...
            tags: ['mens-grooming', 'skincare', 'beginner', 'essentials'],
            difficulty: 'BEGINNER',
            readTime: 8,
...
A simplified routine is easier to maintain, costs less, and reduces the risk of product interactions and irritation.`,
            category: 'SKINCARE_ROUTINE',
            tags: ['minimalist', 'simple', 'beginner-friendly', 'essentials'],
            difficulty: 'BEGINNER',
            readTime: 6,
